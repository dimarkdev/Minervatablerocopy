  ...
  if(!themeChanged){
    ...
    <div class="card">
      ...
      ${(() => {
        ...
        <div class="alert-note" style="margin-top:8px;">${sinCompetencia.length} combinación(es) corte-marca sin ninguna fila de competencia en Envasados, dentro del rango de fechas elegido arriba.</div>`;
      })()}
    </div>
