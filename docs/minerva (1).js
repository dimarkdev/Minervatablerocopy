  ...
  if(!themeChanged){
    ...
    <div class="kpi-grid">
      ${auditCard('envasados', 'Precios auditados en Envasados', fmtNum(ae.total_pdvs),
        ...
        `Puntos de venta distintos (cadena + local) con al menos un precio relevado en Envasados dentro del rango de fechas elegido arriba (${DATA.meta.ventana.desde} a ${DATA.meta.ventana.hasta}). Envasados es la única hoja de precios que abarca tanto supermercados como Biggie. Cambiá el rango de fechas para recalcular.`,
    ...
    crossCompSeleccion = new Set(competenciaDelCorte());
  ...
  if(!themeChanged){
    ...
    <div class="kpi-grid">
      ${kpiCard('Relevamientos', fmtNum(cn.total_relevamientos), `en el rango elegido (${DATA.meta.ventana.dias} días)`,
        'Cantidad de filas de precio cargadas en la hoja Carnicería (Corte + Corte nuevo), dentro del rango de fechas elegido arriba.')}
